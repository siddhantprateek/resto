    ...
    <div className='about-page'>
      ...
      <div className="about-page-header" ref={aboutRef}>
        <h1 className={aboutView ? "trans-from-right-less": ""}>
          About Us <span className='red-dot'>.</span></h1>
        <div className="center-sub-about-header">
          <hr />
        </div>
        <div className={`resto-content-container ${ambView ? "trans-from-left" : ""}`}>
          <p className='about-resto-content'>{ambience?.ambience.description}</p>
        </div>
        <div className={`hotel-image ${ambView ? "trans-from-right-less": ""}`}
          style={{
