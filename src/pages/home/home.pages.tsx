...
const Home = () => {
  ...
  const { ref: highLightRef, inView: highLightView } = useInView({
    threshold: 0,
  });
  ...
  const { ref: showEventTagRef, inView: showEventTagView } = useInView({
    threshold: 0,
  });
  ...
  return (
    <div className="home-page">
      ...
      <div className="highlighted-food-section" ref={highLightRef}>
        <div
          className={`highlighted-food-items ${
            highLightView ? "trans-from-right" : ""
          }`}
        >
          <FoodItem value={0} />
          <FoodItem value={1} />
      ...
      <div className="highlighted-bottom-header">
        <div>
          <h1 className={trendView ? "tracking-in-expand" : ""} ref={trendRef}>
            Trending Today{" "}
          </h1>
      ...
      <div className="dive-into-menu-section">
        <div className="menu-container" ref={expMenuRef}>
          <div
            className={`explore-menu-left-content ${
              expMenuView ? "trans-from-left" : ""
            }`}
          >
            <h1>Fresh & tasty Steaks</h1>
            <p>
              Our fiery dance of flavors features crispy chicken wings coated in
              a smoky chipotle glaze, served with cooling avocado ranch.
            </p>
            <a href="/menu">
      ...
      <div className="chef-recommended">
        <div className="chef-header">
          <div className="recommended-header" ref={chefSpRef}>
            <h1 className={chefSpView ? "trans-from-left" : ""}>
              Our Chefs Special <span className="red-dot">.</span>{" "}
            </h1>
        ...
        <div className="restaurant-cusines">
          <div
            className={`all-cusines-container ${
              foodTagView ? "trans-from-right-less" : ""
            }`}
            ref={foodTagRef}
          >
      ...
      <div className="events-section">
        <div
          className={`explore-events ${
            showEventTagView ? "trans-from-left" : ""
          }`}
          style={{
        ...
        >
          <div
            className={showEventTagView ? "trans-from-right-less" : ""}
            ref={showEventTagRef}
          >
            <h1>
              Make your nights <br /> Memorable
            </h1>
            <p>
              Book Tickets Now..., Enjoy the nights with top singers <br /> and
              artists around the country
            </p>
            <a href="/events">
              <button className="book-ticks-now">Book Now!</button>
            </a>
          </div>
        </div>
      </div>
