...
const Footer = () => {
  ...
  return (
    <div
      className={`footer ${footerView ? "trans-from-top" : ""}`}
      ref={footerRef}
    >
      <div className="sub-footer-1">
        <div className="left-footer-content">
          <p>
            123 Gourmet Avenue,
            <br /> Culinary Metropolis
          </p>
          <p>
            Get Updates On Fun Stuff You <br /> Probably Want To Know About
            <br /> In Your Inbox
          </p>
          <input
            type="email"
            className="get-updated-email"
      ...
      <div className="sub-footer-2">
        <div className="payment-options">
          <a target="__blank" href={website}>
            <img className="social-icon" src={WEBSITEICON} alt="" />
          </a>
        </div>
        <div className="socials">
          <a target="__blank" href={fbUrl}>
            <img className="social-icon" src={FBICON} alt="" />
          </a>
          <a target="__blank" href={igUrl}>
            <img className="social-icon" src={IGICON} alt="" />
          </a>
          <a target="__blank" href={twtUrl}>
