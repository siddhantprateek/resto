...
const RecipeItem = (props: MenuItem) => {
  ...
  const { ref: recipeItemRef, inView: recipeItemView } = useInView({
    threshold: 0,
  });
  ...
  return (
    <div
      className={`recipe-card ${recipeItemView ? "trans-from-top" : ""} ${
        isHovered ? "hovered" : ""
      }`}
    ...
    >
      ...
      <div className="recipe-details">
        <h2 className="recipe-title" onClick={ToRecipeDetail}>
          {props.name}
        </h2>
