  ...
  return (
    <div className="hero">
      <div className="hero-content" ref={heroRef}>
        <h1 className={heroView ? "trans-from-left" : ""}>
          It's not just <span className="red liner">food</span>,<br />
          <img className="fries" src={FRIES} alt="" />
          It's an <span className="blue">experience</span>. 😇
        </h1>
        <div className="secondary-content">
          <p
            className={`hero-content-2 ${
              heroView ? "trans-from-right-less" : ""
            }`}
          >
